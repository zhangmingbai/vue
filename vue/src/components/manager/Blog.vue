  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="cover" label="封面">
          <template v-slot="scope">
            <div style="display: flex; align-items: center">
              <el-image style="width: 50px; height: 50px; border-radius: 5px" preview-teleported="“true”" v-if="scope.row.cover"
        ...
        <el-table-column label="操作" width="180" style="margin-left: 10px">
          <template v-slot="scope">
    ...
    <el-dialog v-model="fromVisible" title="信息" width="60%" :close-on-click-modal="false" destroy-on-close>
    ...
    <el-dialog title="文章内容" v-model="fromVisible1" width="50%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">
